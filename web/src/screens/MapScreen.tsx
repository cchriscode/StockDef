...
// 캡션 기준(DMZ 38°N = 37.75행, 0.14°/셀)으로 역산한 실제 좌표.
// 기존 여의도 표시는 37.83°N에 있어 실제(37.52°N)보다 34km 북쪽이었다.
const KR_MARKS: Record<string, { x: number; y: number }> = {
  R1: { x: 117, y: 329 }, // 여의도 37.52°N 126.93°E
  R2: { x: 124, y: 336 }, // 판교 37.40°N 127.10°E
  R3: { x: 212, y: 443 }, // 울산 35.54°N 129.31°E
};
