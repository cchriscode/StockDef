...
export const UNIT_INFO: Record<UnitSpec['key'], InfoCard> = {
  ...
  analyst: {
    role: '원거리 딜러',
    desc: '후방에서 활로 저격합니다. 공중은 때리지 못하니 드론 웨이브는 포탑으로 막으세요.',
  ...
  gasmask: { role: '원거리 · 장악', desc: '독가스탄으로 밀집 지점을 무력화합니다. 지상 적 전용이라, 공중으로 뜬 확성기 드론은 포탑에 맡겨야 합니다.', skill: '독가스탄 (12초) — 착탄 광역 ×1.0 + 둔화 20% + 회복 차단 5초.' },
...
export const ENEMY_INFO: Record<string, { role: string; desc: string; skill: string }> = {
  ...
  boss: {
    role: '중간 보스 · 제압형',
    desc: '웨이브 7에 등장합니다(R2·R3). 마법 저항이 높아 스파이어로는 잘 녹지 않고, 전열을 기절시켜 방어선을 잠시 마비시킵니다. 기절 중에는 블로커가 적을 붙잡지 못하니 뒤의 물량이 함께 밀고 들어옵니다.',
    skill: '낙뢰 심판 (15초) — 앞선 아군 2기에 낙뢰. 피해 ×0.8 + 0.5초 기절 + 3초간 받는 피해 +12%.',
  },
  boss_drill: {
    role: '최종 보스 · 전열 갈이형',
    desc: '마지막 웨이브에 등장합니다. 보스 중 가장 단단하고(방어 35%) 느리며, 전열을 갈아 넣듯 밀고 들어옵니다. 물리 방어가 높아 옵션 스파이어의 마법 피해가 잘 듭니다.',
    skill: '관통 굴착 (13초) — 앞선 아군 3기를 관통. 피해 ×1.1 + 2.5초간 둔화 45% + 받는 피해 +25%.',
  },
};
